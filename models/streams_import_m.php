...
class Streams_import_m extends MY_Model
{
	...
	public function get_profile_object($id) //just one profile object constructed...
	{
		return $this->streams->entries->get_entry($id,$this->stream_slug, $this->namespace, TRUE);
	}
